...
{
    [TestClass]
    public class TestViewModelBridgeMessage
    {
        [TestMethod]
        public void TestViewModelBridgeMessageFunctionNameIsNull()
        {
            OpenMVVM.WebView.BridgeMessage bridgeMessage = new OpenMVVM.WebView.BridgeMessage()
            { FunctionName = null, Params = new object[] { "" } };
            Assert.AreEqual(bridgeMessage.FunctionName, null);
        }
        [TestMethod]
        public void TestViewModelBridgeMessageFunctionNameIsEmptyString()
        {
            OpenMVVM.WebView.BridgeMessage bridgeMessage = new OpenMVVM.WebView.BridgeMessage()
            { FunctionName = "", Params = new object[] { "" } };
            Assert.AreEqual((string)bridgeMessage.FunctionName, "");
        }
        [TestMethod]
        public void TestViewModelBridgeMessageFunctionNameIsOneWordString()
        {
            OpenMVVM.WebView.BridgeMessage bridgeMessage = new OpenMVVM.WebView.BridgeMessage()
            { FunctionName = "FunctionName", Params = new object[] { "" } };
            Assert.AreEqual((string)bridgeMessage.FunctionName, "FunctionName");
        }
        [TestMethod]
        public void TestViewModelBridgeMessageFunctionNameIsLongString()
        {
            OpenMVVM.WebView.BridgeMessage bridgeMessage = new OpenMVVM.WebView.BridgeMessage()
            {
                FunctionName = @"# Welcome to OpenMVVM Project!
...
", Params = new object[] { "" } };
             ...
             Assert.AreEqual((string) bridgeMessage.FunctionName, @"# Welcome to OpenMVVM Project!
